...
import com.dsousa.minnhasfinancas.model.repository.LancamentoRepository;
...
public class LancamentoSeriviceImpl implements LancamentoService {
	...
	public LancamentoSeriviceImpl(LancamentoRepository repository) {
	...
	public void validar(Lancamento lancamento) {
		if(lancamento.getDescricao() == null || lancamento.getDescricao().trim().equals("")) {
			throw new RegraNegocioException("Informe uma descriçaõ válida.");
		}
	...
	public BigDecimal obterSaldoPorUsuario(Long id) {
		BigDecimal receitas = repository.obeterSaldoPorTipoLancamentoEUsuarioEStatus(id, TipoLancamento.RECEITA, StatusLancamento.EFETIVADO);
		BigDecimal despesas = repository.obeterSaldoPorTipoLancamentoEUsuarioEStatus(id, TipoLancamento.DESPESA, StatusLancamento.EFETIVADO);
